    ...
    public class ClassStudent
    {
        ...
        public int getClassStudentDetails(ref DataSet result)
        {
            ...
            if (ds.Tables["getClassStudentDetails"].Rows.Count > 0)
            {
                ...
                if (!DBNull.Value.Equals(ds.Tables["getClassStudentDetails"].Rows[0]["feedback"].ToString()))
                    feedback = Convert.ToString(ds.Tables["getClassStudentDetails"].Rows[0]["feedback"]);
